...
class TranslationService:
    ...
    def auto_translate_fields(self, data: dict, fields_to_translate: list) -> dict:
        ...
        - content always contains French text
        - content_ar always contains Arabic text
        ...
        for field in fields_to_translate:
            ...
            # Case 1: Only main field has content (content provided)
            ...
            # Case 2: Only _ar field has content (content_ar provided)
